...
@ExtendWith(SpringExtension.class)  // étendre le support de JUnit 5 avec les fonctionnalités de test de Spring
@SpringBootTest  // charger l'application contexte complet lors de l'exécution des tests
@Transactional
